...
export const Route = createFileRoute("/obrigadofullface")({
  ...
  head: () => ({
    meta: [
      { title: "Inscrição recebida | Curso Full Face | L'ECLER Academy" },
      {
        name: "description",
        content:
          "Recebemos sua inscrição para o Curso Full Face. Em breve nossa equipe entrará em contato pelo WhatsApp para confirmar sua vaga.",
      },
          ...
          <div className="mt-8 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5 text-left">
            ...
            <ul className="mt-3 space-y-3 text-sm text-white/80">
              ...
              <li className="flex items-start gap-2">
                ...
                Prepare-se para uma imersão em planejamento facial completo e Harmonização Orofacial
                Full Face.
              </li>
            </ul>
          </div>
