...
export const Route = createFileRoute("/cursoadvancedlips")({
  ...
  head: () => ({
    meta: [
      { title: "Curso Advanced Lips | 17 e 18 de setembro de 2026 | L'ECLER Academy" },
      {
        name: "description",
        content:
          "Curso presencial Advanced Lips em Harmonização Orofacial com a Dra. Cássia Blasques. Planejamento labial, técnica, segurança e naturalidade para tratamentos labiais e periorais.",
      },
      {
        property: "og:title",
        content: "Curso Advanced Lips | 17 e 18 de setembro de 2026",
      },
      {
        property: "og:description",
        content:
          "Imersão presencial para profissionais que desejam evoluir em tratamentos labiais e periorais com raciocínio clínico, anatomia, segurança e naturalidade.",
      },
...
function CursoAdvancedLipsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      fetch("https://projeto01-n8n.gmxuno.easypanel.host/webhook/advancedlipssetembro", {
        method: "POST",
        ...
        <div className="relative">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-white/70">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 ring-1 ring-white/10">
              <Calendar className="h-4 w-4 text-[#c9a84c]" /> 17 e 18 de setembro de 2026
            </span>
            <span className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 ring-1 ring-white/10">
          ...
          <div className="mt-6 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5">
            ...
            <p className="mt-1 font-display text-2xl">
              ...
              <span className="text-sm font-sans font-normal text-white/60">
                em tratamentos labiais e periorais
              </span>
            </p>
            <p className="mt-2 text-sm text-white/70">
              Planejamento labial, leitura facial, anatomia aplicada, técnica e condução clínica
              para resultados naturais, seguros e coerentes com a identidade do paciente.
            </p>
          </div>

          <ul className="mt-6 space-y-2 text-sm text-white/80">
            {[
              "Planejamento labial com raciocínio anatômico, estético e funcional",
              "Técnicas para lábios e região perioral com segurança clínica",
              "Turma reduzida para uma experiência próxima e direcionada",
            ].map((t) => (
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] backdrop-blur">
            <div className="border-b border-white/10 bg-[#c9a84c]/10 px-6 py-5">
              ...
              <p className="mt-1.5 text-sm text-white/60">
                Nossa equipe entrará em contato para confirmar sua matrícula e enviar as informações
                da turma.
              </p>
            </div>
