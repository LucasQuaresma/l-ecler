  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Curso Full Face | L'ECLER Academy" },
      {
        ...
        content:
          "Imersão presencial para profissionais que desejam evoluir em planejamento Full Face com visão clínica, segurança e naturalidade.",
      },
...
function CursoFullFacePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      fetch("https://projeto01-n8n.gmxuno.easypanel.host/webhook/fullfaceagosto", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen bg-[#0e0a08] text-white">
      <CoursePixelTracker route="/cursofullface" />
      <div
        aria-hidden
          ...
          <div className="mt-6 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5">
            ...
            <p className="mt-1 font-display text-2xl">
              ...
              <span className="text-sm font-sans font-normal text-white/60">
                em Harmonização Orofacial Full Face
              </span>
            </p>
            <p className="mt-2 text-sm text-white/70">
              Planejamento facial completo, integração de técnicas e condução clínica para entregar
              resultados naturais, seguros e coerentes com a identidade do paciente.
            </p>
          </div>

          <ul className="mt-6 space-y-2 text-sm text-white/80">
            {[
              "Planejamento Full Face com raciocínio anatômico e estético",
              "Combinação estratégica de técnicas em Harmonização Orofacial",
