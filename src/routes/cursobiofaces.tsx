...
export const Route = createFileRoute("/cursobiofaces")({
  ssr: false,
  head: () => ({
    meta: [
      { title: "Curso BIOFACES | 02 e 03 de outubro de 2026 | L'ECLER Academy" },
      {
        name: "description",
        content:
          "Curso presencial BIOFACES em Harmonização Orofacial com a Dra. Cássia Blasques. Bioestimulação, biorregeneração, técnica, segurança e naturalidade na prática clínica.",
      },
      {
        property: "og:title",
        content: "Curso BIOFACES | 02 e 03 de outubro de 2026",
      },
      {
        property: "og:description",
        content:
          "Imersão presencial para profissionais que desejam evoluir em bioestimulação, biorregeneração e tecnologias atuais com raciocínio clínico, segurança e previsibilidade.",
      },
      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-6 py-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:py-16">
        <div className="relative">
          ...
          <div className="mt-6 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5">
            ...
            <p className="mt-1 font-display text-2xl">
              ...
              <span className="text-sm font-sans font-normal text-white/60">
                em bioestimulação e biorregeneração
              </span>
            </p>
          ...
          <ul className="mt-6 space-y-2 text-sm text-white/80">
            {[
              "Raciocínio clínico para indicação de bioestimuladores e biorregeneradores",
              "Protocolos atuais com foco em naturalidade, pele e reestruturação facial",
