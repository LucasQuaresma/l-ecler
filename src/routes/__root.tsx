    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-gradient-gold px-5 py-2 text-sm font-semibold text-primary shadow-gold transition-transform hover:scale-[1.02]"
          >
            Voltar ao início
          </Link>
        </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="rounded-full bg-gradient-gold px-5 py-2 text-sm font-semibold text-primary shadow-gold"
          >
            Tentar novamente
          </button>
          <a
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Converse com a equipe da L'ECLER e entenda o melhor plano para cuidar do sorriso, da face e da autoestima." },
      { name: "twitter:description", content: "Converse com a equipe da L'ECLER e entenda o melhor plano para cuidar do sorriso, da face e da autoestima." },
    ...
    scripts: [
      {
        children: `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','4520973931556677');fbq('trackSingle','4520973931556677','PageView');`,
      },
      {
        async: true,
        src: "https://www.facebook.com/tr?id=4520973931556677&ev=PageView&noscript=1",
      },
    ],
  }),
