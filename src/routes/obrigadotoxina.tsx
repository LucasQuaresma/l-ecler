...
export const Route = createFileRoute("/obrigadotoxina")({
  ...
  head: () => ({
    meta: [
      { title: "Inscrição recebida | Curso Toxina Botulínica | L'ECLER Academy" },
      {
        name: "description",
        content:
          "Recebemos sua inscrição para o Curso Toxina Botulínica. Em breve nossa equipe entrará em contato pelo WhatsApp para confirmar sua vaga.",
      },
...
function Page() {
  useEffect(() => {
    trackMetaLead({
      content_name: "Curso Toxina Botulínica",
      ...
      <main className="relative mx-auto flex min-h-screen max-w-3xl items-center justify-center px-6 py-16">
        ...
        >
          ...
          <p className="mt-4 text-white/70">
            ...
            confirmar sua matrícula e enviar todos os detalhes da imersão.
          </p>
          ...
          <div className="mt-8 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5 text-left">
            ...
            <ul className="mt-3 space-y-3 text-sm text-white/80">
              ...
              <li className="flex items-start gap-2">
                ...
                Prepare-se para uma imersão em Toxina Botulínica com planejamento, técnica e
                segurança clínica.
              </li>
            </ul>
          </div>
