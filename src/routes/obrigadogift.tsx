...
import { CheckCircle2, MessageCircle, ArrowLeft, Gift, Sparkles, Heart } from "lucide-react";
import { Button } from "@/components/ui/button";

export const Route = createFileRoute("/obrigadogift")({
  ssr: false,
  head: () => ({
    meta: [
          ...
          <div className="mt-8 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5 text-left">
            ...
            <ul className="mt-3 space-y-3 text-sm text-white/80">
              <li className="flex items-start gap-2">
                ...
                Vamos chamar você no WhatsApp para entender o perfil de quem você quer presentear.
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a84c]" />
                Você receberá as opções de voucher e as experiências disponíveis na L'ECLER.
              </li>
              <li className="flex items-start gap-2">
                <Heart className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a84c]" />
                Escolha o voucher e presenteie com saúde, bem-estar e cuidado L'ECLER.
              </li>
            </ul>
          </div>
