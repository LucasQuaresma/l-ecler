...
export const Route = createFileRoute("/obrigadoadvancedlips")({
  ...
  head: () => ({
    meta: [
      { title: "Inscrição recebida | Curso Advanced Lips | L'ECLER Academy" },
      {
        name: "description",
        content:
          ...
          <div className="mt-8 rounded-2xl border border-[#c9a84c]/30 bg-[#c9a84c]/5 p-5 text-left">
            ...
            <ul className="mt-3 space-y-3 text-sm text-white/80">
              ...
              <li className="flex items-start gap-2">
                ...
                Prepare-se para uma imersão em Advanced Lips com planejamento labial, técnica e
                segurança clínica.
              </li>
            </ul>
          </div>
